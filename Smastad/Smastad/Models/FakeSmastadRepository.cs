...
{
public class FakeSmastadRepository : ISmastadRepository //fake repo for using faked data
{
    private ApplicationDbContext context;

    public FakeSmastadRepository(ApplicationDbContext ctx)
    {
        context = ctx;
    }
        ...
        {
            new Errand { ErrandId = 2018-45-0001,
            ...
            new Errand { ErrandId = 2018-45-0002,
                         Place = "Småstadsjön",
            ...
            new Errand { ErrandId = 2018-45-0003,
                         Place = "Ödehuset",
                         TypeOfCrime = "Skrot",
            ...
            new Errand { ErrandId = 2018-45-0004,
            ...
            new Errand { ErrandId = 2018-45-0005,
                         Place = "Torget",
                         TypeOfCrime = "Klotter",
